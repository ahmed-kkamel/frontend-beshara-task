    ...
    <div className="relative" ref={menuRef}>
      {user ? (
          ...
          <AnimatePresence>
            {isOpen && (
              <motion.div
                ...
                className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl py-2 border border-gray-100"
              >
        ...
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          <Link
            href="/auth/login"
            className="flex items-center space-x-2 px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-medium hover:shadow-md transition-all duration-200"
          >
